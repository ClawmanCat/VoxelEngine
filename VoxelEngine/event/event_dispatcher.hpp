...
namespace ve {
    ...
    public:
        ...
        event_handler_id add_handler(universal<handler_t> auto&& handler, ve_default_actor(owner)) {
        ...
        void remove_handler(event_handler_id id) {
            ...
            if (lookup_it == handlers.end()) return;
        ...
        void dispatch_event(const Event& evnt) {
            ...
            for (const auto& [priority, handlers] : handler_storage_it->second | views::reverse) {

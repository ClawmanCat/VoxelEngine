...
test_result test_main(void) {
    using mt_args = typename ve::mouse_motion_input::args;
    ...
    binder.create_alias("motion", ve::mouse_motion_input { mt_args { .trigger_on = trigger::MOTION_START | trigger::MOTION_TICK | trigger::MOTION_END } });

...
namespace ve::gfx::vulkan {
    ...
    const inline hash_map<VkFormat, image_format_info> image_formats {
        ...
        std::pair { VK_FORMAT_B8G8R8_UNORM,               image_format_info { 24, 3, { 8,  8,  8,  0  }, VK_IMAGE_ASPECT_COLOR_BIT } },
        std::pair { VK_FORMAT_B8G8R8A8_UNORM,             image_format_info { 32, 4, { 8,  8,  8,  8  }, VK_IMAGE_ASPECT_COLOR_BIT } },
        // 8-bit RGBA and BGRA with SRGB
        ...
        std::pair { VK_FORMAT_B8G8R8_SRGB,                image_format_info { 24, 3, { 8,  8,  8,  0  }, VK_IMAGE_ASPECT_COLOR_BIT } },
        std::pair { VK_FORMAT_B8G8R8A8_SRGB,              image_format_info { 32, 4, { 8,  8,  8,  8  }, VK_IMAGE_ASPECT_COLOR_BIT } },
        ...
        std::pair { VK_FORMAT_D24_UNORM_S8_UINT,          image_format_info { 32, 1, { 24, 8,  0,  0  }, VK_IMAGE_ASPECT_DEPTH_BIT | VK_IMAGE_ASPECT_STENCIL_BIT } },

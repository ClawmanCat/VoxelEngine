...
// Define this macro to your own voxel_settings type to use custom settings.
// Your type should have the same fields as ve::detail::voxel_settings.
#ifndef VE_VOXEL_SETTINGS_TYPE
    #define VE_VOXEL_SETTINGS_TYPE ve::detail::voxel_settings
#endif


namespace ve {
    namespace detail {
        struct voxel_settings {
    ...
    using voxel_settings = VE_VOXEL_SETTINGS_TYPE;

...
namespace ve::voxel {
    ...
    constexpr inline tilepos to_chunkpos(const tilepos& worldpos) {
    ...
    constexpr inline tilepos to_worldpos(const tilepos& chunkpos, const tilepos& offset = tilepos { 0 }) {
    ...
    constexpr inline tilepos to_localpos(const tilepos& worldpos) {
    ...
    constexpr inline direction_t neighbour_direction(const tilepos& localpos) {

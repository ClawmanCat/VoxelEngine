...
namespace demo_game {
    ...
    public:
        ...
        static auto remote_initializer(void) {
            return [] (entt::entity entity, ve::registry& owner) {
                ...
                owner.template set_component<ve::mesh_component>(entity, make_howlee_mesh());
                owner.template set_component<render_tag_simple>(entity, render_tag_simple {});
            };
        }
        ...
        explicit howlee(ve::registry& registry, class world* world) : ve::static_entity(registry), world(world) {
            ...
            if (emissive_howlees < 127 && ve::cheaprand::random_real() < (1.0f / 32.0f)) {
